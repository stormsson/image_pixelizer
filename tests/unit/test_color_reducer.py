...
class TestColorReducer:
    ...
    def test_reduce_colors_with_k_parameter(self) -> None:
        """Test color reduction with explicit k parameter."""
        reducer = ColorReducer()
    ...
    def test_reduce_colors_kmeans_alpha_binary(self) -> None:
        """Test that K-Means binarizes alpha channel correctly."""
        reducer = ColorReducer()
        ...
        pixel_data[0, 2, 3] = 128  # Threshold alpha
        ...
        assert result.pixel_data[0, 2, 3] == 255  # 128 becomes 255
        # Values < 128 should become 0
        assert result.pixel_data[0, 3, 3] == 0
